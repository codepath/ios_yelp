...
-(void)initCategories {
    ...
    @[
      ...
      @{@"name" : @"Asian Fusion", @"code": @"asianfusion", @"top": @"yes" },
...
//      @{@"name" : @"Black Sea", @"code": @"blacksea" },
      ...
      @{@"name" : @"Breakfast & Brunch", @"code": @"breakfast_brunch", @"top": @"yes" },
      @{@"name" : @"British", @"code": @"british" },
      @{@"name" : @"Buffets", @"code": @"buffets" },
//      @{@"name" : @"Bulgarian", @"code": @"bulgarian" },
      @{@"name" : @"Burgers", @"code": @"burgers", @"top": @"yes" },
...
//      @{@"name" : @"Signature Cuisine", @"code": @"signature_cuisine" },
      ...
      @{@"name" : @"Sushi Bars", @"code": @"sushi", @"top": @"yes" },
